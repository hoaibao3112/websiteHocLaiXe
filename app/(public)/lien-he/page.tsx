          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 space-y-6 sm:space-y-8">
              ...
              <ScrollReveal animation="slide-right">
                <div className="bg-slate-50 rounded-2xl border border-neutral-100 p-5 sm:p-8 space-y-5 sm:space-y-6">
                  <h2 className="text-base sm:text-lg font-bold text-neutral-900 border-b border-neutral-200/60 pb-3 sm:pb-4 flex items-center gap-2">
              ...
              <ScrollReveal animation="slide-right" delay={150}>
                <div className="bg-[#1e3a8a] text-white rounded-2xl shadow-xl p-6 sm:p-8 relative overflow-hidden group">
                  ...
                  <p className="text-neutral-200 text-xs sm:text-sm leading-relaxed mb-5 sm:mb-6">
            ...
            <ScrollReveal animation="slide-left" className="lg:col-span-7">
              <div className="bg-white rounded-2xl border border-neutral-100 p-5 sm:p-10 shadow-xl sm:shadow-2xl">
                <h2 className="text-lg sm:text-2xl font-extrabold text-neutral-900 mb-2">
                  Liên hệ qua Zalo & Hotline
                </h2>
                <p className="text-neutral-400 text-xs sm:text-sm mb-6 sm:mb-8">
