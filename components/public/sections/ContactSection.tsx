        ...
        <div className="grid lg:grid-cols-12 gap-8 sm:gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-6 sm:space-y-8">
            <ScrollReveal animation="slide-right">
              <div>
                <div className="inline-flex items-center gap-2 bg-amber-50 text-amber-700 border border-amber-200 text-xs font-bold px-4 py-2 rounded-full uppercase tracking-widest mb-4 sm:mb-5">
                  <Phone className="w-3.5 h-3.5" />
                  Liên hệ ngay
                </div>
                <h2 className="font-display text-2xl sm:text-3xl font-extrabold text-[#1e3a8a] mb-2 sm:mb-3">
            ...
            <ScrollReveal animation="slide-right" delay={100}>
              <div className="space-y-4">
                {CONTACT_INFO.map(({ icon: Icon, label, value, href }) => (
                  <div key={label} className="flex gap-3 sm:gap-4 items-start group">
                    ...
                    <div>
                      ...
                      {href ? (
                        ...
                        <p className="text-neutral-700 text-xs sm:text-sm leading-snug">{value}</p>
                      )}
                    </div>
                  </div>
                ))}
          ...
          <div className="lg:col-span-7">
            <ScrollReveal animation="slide-left" delay={200}>
              <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-10 shadow-xl sm:shadow-2xl border border-neutral-100">
                <h3 className="text-base sm:text-lg font-bold text-neutral-900 mb-1">Gửi yêu cầu tư vấn</h3>
                <p className="text-neutral-400 text-xs mb-5 sm:mb-6">Chúng tôi sẽ liên hệ hỗ trợ bạn trong thời gian sớm nhất.</p>
                <HomepageContactForm />
              </div>
            </ScrollReveal>
          </div>
